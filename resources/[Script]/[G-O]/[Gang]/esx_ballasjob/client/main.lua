...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
	...
	-- double job
    --if zone == 'SellPoint' and PlayerData.job ~= nil and PlayerData.job.name == 'ballas'  then
      --table.insert(elements, {label = _U('buy_weapons'), value = 'buy_weapons'})
    --end
	--if zone == 'SellPoint' and PlayerData.job2 ~= nil and PlayerData.job.name == 'ballas'  then
     -- table.insert(elements, {label = _U('buy_weapons'), value = 'buy_weapons'})
    --end
	--if zone == 'SellPoint' and PlayerData.job3 ~= nil and PlayerData.job.name == 'ballas'  then
      ---table.insert(elements, {label = _U('buy_weapons'), value = 'buy_weapons'})
    --end
