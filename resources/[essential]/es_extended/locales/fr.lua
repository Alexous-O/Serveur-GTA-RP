Locales['fr'] = {
  ...
  -------- COMMANDE BAN AVERTISSEMENT ASSISTANCE BWH ... ---------------

  ['bwh'] = '/bwh assists, ban, banlist, warn, warnlist, refresh',
  ['assist'] = 'Demander de l\'aide ou signaler un problème vers un administrateur',
  ['cassist'] = 'Annuler la demande d\'assistance',
  ['accassist'] = 'Accepter la demande d\'assistance',
  ['decassist'] = 'Refuser la demande d\'assistance',
  ['finassist'] = 'Fermer la demande d\'assistance',
  ...
  ['repair'] = 'Réparer le véhicule',
  ['chat_clear'] = 'vider le chat',
  ['chat_clear_all'] = 'vider le chat pour tous le monde',
  ['command_clearinventory'] = 'effacer tout les objets de l\'inventaire',
  ['command_clearloadout'] = 'retirer toutes les armes',
  ['command_playerid_param'] = 'spécifiez l\'id du joueur ou laissez vide pour vous-même',
  -- Locale settings
  ['locale_digit_grouping_symbol'] = ' ',
  ['locale_currency'] = '$%s',

  ----------------- NOUVELLE TRADUCTION COMMANDE ----------------
  ['911'] = '/911 + message: Signaler un problème à la police sur ma position',
  ['givecarkey'] = 'donner un véhicule',
  ['911a'] = '/911a + message: signaler ma position à une ambulance',
  ['me'] = 'Afficher une action au dessus du joueur',
  ['ooc'] = 'ecrit un message hors du personnage',
  ['news'] = 'annonce une information pour les jobs (ne pas en abuser)',
  ['speedoskin'] = 'Changer le compteur de vitesse',
  ['speedoskins'] = 'Liste des skins du compteur de vitesse',
  ['ano'] = 'Envoyer un tweet anonyme',
  ['twt'] = 'Envoyer un tweet',
  ['lspd'] = 'Annonce LSPD',
  ['ems'] = 'Annonce EMS',
  ['meca'] = 'Annonce Mécano',
  ['imob'] = 'Annonce Agent immobilier',
  ['bsco'] = 'Annonce Sheriff',
  ['conc'] = 'Annonce Concessionnaire',
  ['coords'] = 'Afficher les coordonnées',
  ['heading'] = 'Coordonnées Heading',
  ['evening'] = 'Changer l\'heure sur le soir',
  ['takehostage'] = 'Prendre un joueur en otage',
  ['th'] = 'Raccourci prendre un joueur en otage',
  ['togglespeedo'] = 'Afficher/Cacher compteur voiture',
  ['time'] = 'Changer l\'heure',
  ['piggyback'] = 'Porter un joueur sur le dos',
  ['carry'] = 'Porter un joueur sur les épaules',
  ['bodybag'] = 'Sac mortuaire Police/EMS',
  ['shield'] = 'Bouclier de protection Police',
  ['setgroup'] = 'Assigner un groupe de permission',
  ['do'] = 'Faire une action',
  ['freezeweather'] = 'Freeze la météo',
  ['freezetime'] = 'Freeze le temps',
  ['morning'] = 'Changer l\'heure sur le matin',
  ['weather'] = 'Changer la météo',
  ['blackout'] = 'Ville en mode Blackout',
  ['night'] = 'Changer l\'heure sur la nuit',
  ['noon'] = 'Changer l\'heure sur midi',
  ...
  -- Weapon Components
  ['component_clip_default'] = 'poignée par défaut',
  ['component_clip_extended'] = 'poignée étendue',
  ['component_clip_drum'] = 'drum Magazine',
  ['component_clip_box'] = 'boite de munitions',
  ['component_flashlight'] = 'lampe',
  ['component_scope'] = 'lunette de précision',
  ['component_scope_advanced'] = 'Lunette de précision améliorée',
  ['component_suppressor'] = 'silencieux',
  ['component_grip'] = 'poignée',
  ['component_luxary_finish'] = 'Finition luxe',
}
